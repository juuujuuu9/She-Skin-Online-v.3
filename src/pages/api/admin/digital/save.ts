...
/**
 * POST /api/admin/digital/save — Create or update a digital work (database)
 */
...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    const { item, isNew } = body as { item: DigitalItem; isNew: boolean };
    ...
    if (!existing || existing.category !== 'digital') {
    ...
    console.error('Digital save error:', err);
    return new Response(
